      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-8">
          <div className="max-w-2xl">
            ...
            >
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-primary">Best Sellers</span>
            </motion.div>
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Pune's favorite <span className="text-primary italic font-serif font-normal">Pantry Essentials</span>.
            </motion.h2>
          </div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          {bestSellers.map((product, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-1 mb-3">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} size={12} className={cn(i < 4 ? "text-primary fill-primary" : "text-black/10")} />
                ))}
                <span className="text-[10px] font-bold opacity-30 ml-2 uppercase tracking-widest">4.8 (120 Reviews)</span>
              </div>
              ...
              <div className="flex justify-between items-start gap-4 mb-4">
                ...
                <div className="text-right">
                  ...
                  <p className="text-[10px] font-bold opacity-30 uppercase tracking-widest">Per {product.unit}</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between pt-6 border-t border-black/5">
                <div className="flex -space-x-2">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="w-8 h-8 rounded-full border-2 border-white bg-black/5 overflow-hidden">
                ...
                <span className="text-[10px] font-bold opacity-50 uppercase tracking-widest">Happy Customers</span>
              </div>
            </motion.div>
          ))}
        </div>
        <div className="mt-20 pt-16 border-t border-black/5">
          <div className="text-center mb-12">
            <h3 className="text-2xl font-bold tracking-tight">Explore our full range</h3>
          </div>
